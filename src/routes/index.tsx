...
const HomeStatsCard = lazy(() =>
  import("@/components/HomeStatsCard").then((m) => ({
    default: m.HomeStatsCard,
  })),
);
  ...
  head: () => ({
    meta: [
      { title: "Verbete — Ganhar conhecimento nunca foi tão divertido!" },
      {
        name: "description",
        content:
          "Verbete: conhecimento nunca foi tão divertido. Multiplayer em tempo real para até 12 amigos blefarem com palavras raras.",
      },
      {
        property: "og:title",
      ...
      },
      {
        ...
        content:
          "Multiplayer em tempo real para até 12 amigos. Blefa, vota e ri muito.",
      },
        ...
        <>
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(255,0,128,0.55) 0%, transparent 70%)",
                filter: "blur(60px)",
              }}
            />
          ...
          >
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(180deg, #4dffcf 0%, #00e5b8 100%)",
                  border: "3px solid #ffffff",
                  boxShadow:
                    "0 6px 0 #00b892, 0 12px 20px -6px rgba(0,229,184,0.6)",
                }}
              >
                ?
                <span
            ...
            <motion.div
              ...
              style={{
                ...
                height: 260,
                background:
                  "radial-gradient(circle, rgba(255,0,150,0.7) 0%, rgba(255,0,150,0.25) 45%, transparent 75%)",
                filter: "blur(30px)",
              }}
            ...
            <motion.p
              ...
              style={{
                color: "#ffffff",
                textShadow:
                  "0 2px 0 rgba(76,26,143,0.55), 0 4px 12px rgba(0,0,0,0.35)",
              }}
            >
          ...
          >
            ...
            <motion.button
              ...
              style={{
                background:
                  "linear-gradient(180deg, #fff17a 0%, #ffde00 55%, #f5c500 100%)",
                color: "#4c1a8f",
                border: "3px solid #ffffff",
                boxShadow:
                ...
                const inner = (
                  <div
                    ...
                    style={{
                      ...
                      boxShadow:
                        "inset 0 1px 0 rgba(255,255,255,0.4), 0 8px 20px -10px rgba(0,0,0,0.5)",
                    }}
                  >
                    ...
                    {item.badge && (
                      <span
                        ...
                        style={{
                          background:
                            "linear-gradient(180deg, #fff17a, #ffde00)",
