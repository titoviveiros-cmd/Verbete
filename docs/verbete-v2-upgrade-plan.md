...
- [x] Fase 4 (coreografia, TODAS aprovadas por prévia em 2026-07-20): 1/3 clímax da revelação (blefes eliminados um a um de baixo p/ cima, verdade coroando o TOPO, chuva de pontos, "ninguém acertou → coordenador +2"); 2/3 placar com ultrapassagem (ordem anterior → desliza p/ nova, contador rolante, pulso em quem subiu); 3/3 pódio na tela final (degraus 1º/2º/3º, campeão maior com coroa). **Pendente: validação visual do usuário no celular**
