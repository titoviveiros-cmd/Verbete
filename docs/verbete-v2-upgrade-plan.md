...
- [ ] Fase 10 · parte 2 (pendente): split do `use-room` (~870 linhas) em módulos (data/realtime/presence/polling/actions/optimistic), um por commit com E2E verde entre cada; zerar os 67 avisos restantes (exhaustive-deps exige análise caso a caso)
