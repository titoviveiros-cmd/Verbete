...
- [ ] Fase 2 · parte 2: Playwright multi-contexto (host + jogadores, ciclo completo, reconexão), suíte SQL via supabase local no CI; segredos do repo p/ job de integração (SUPABASE_DB_URL, SUPABASE_URL, SUPABASE_ANON_KEY — hoje o job pula)
- [ ] Fases 3–10 (pendentes)
