...
DECLARE
  ...
  v_pending_after_kick boolean := false;
BEGIN
  ...
  LOOP
    ...
    ELSE
      ...
      INSERT INTO public.round_extensions (room_id, round, player_id, attempt)
      VALUES (p_room_id, v_room.current_round, v_pending.id, 3)
      ON CONFLICT DO NOTHING;
  ...
  ) INTO v_pending_after_kick;

  IF v_pending_after_kick THEN
    UPDATE public.rooms
...
GRANT EXECUTE ON FUNCTION public.extend_voting_or_advance(uuid) TO anon, authenticated;
